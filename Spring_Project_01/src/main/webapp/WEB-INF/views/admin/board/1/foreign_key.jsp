<%-- File Location: /views/admin/board/1/foreign_key.jsp --%>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div id="searchForm" style="display:none; margin-top:10px;">
                            <form action="${root}admin/board/1/search?returnJSP=foreignJSP" method="post" onsubmit="removeEmptyFields(event)">
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            <thead>
                                <tr>
                                    <th><a href="${root}admin/board/1/sort?returnJSP=foreignJSP&sortField=boardId">ID <i class="fas ${filter.boardIdOrder == 'asc' ? 'fa-sort-up' : filter.boardIdOrder == 'desc' ? 'fa-sort-down' : 'fa-sort'}"></i></a></th>
                                    <th><a href="${root}admin/board/1/sort?returnJSP=foreignJSP&sortField=userIdx">유저 ID <i class="fas ${filter.userIdxOrder == 'asc' ? 'fa-sort-up' : filter.userIdxOrder == 'desc' ? 'fa-sort-down' : 'fa-sort'}"></i></a></th>
                                    <th><a href="${root}admin/board/1/sort?returnJSP=foreignJSP&sortField=boardTitle">제목 <i class="fas ${filter.titleOrder == 'asc' ? 'fa-sort-up' : filter.titleOrder == 'desc' ? 'fa-sort-down' : 'fa-sort'}"></i></a></th>
                                    <th><a href="${root}admin/board/1/sort?returnJSP=foreignJSP&sortField=boardContent">내용 <i class="fas ${filter.contentOrder == 'asc' ? 'fa-sort-up' : filter.contentOrder == 'desc' ? 'fa-sort-down' : 'fa-sort'}"></i></a></th>
                                    <th><a href="${root}admin/board/1/sort?returnJSP=foreignJSP&sortField=dateOrder">날짜 <i class="fas ${filter.dateOrder == 'asc' ? 'fa-sort-up' : filter.dateOrder == 'desc' ? 'fa-sort-down' : 'fa-sort'}"></i></a></th>
                                    <th><a href="${root}admin/board/1/sort?returnJSP=foreignJSP&sortField=viewsOrder">조회수 <i class="fas ${filter.viewsOrder == 'asc' ? 'fa-sort-up' : filter.viewsOrder == 'desc' ? 'fa-sort-down' : 'fa-sort'}"></i></a></th>
                                    <th>선택</th>
                                </tr>
                            </thead>
                            <tbody>
