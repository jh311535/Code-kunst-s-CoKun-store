<%-- File Location: /views/admin/board/2/modify.jsp --%>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">QnA 질문 수정</h3>
                        </div>
                        <div class="card-body">
                            <form action="${root}admin/board/2/modify" method="post" enctype="multipart/form-data">
