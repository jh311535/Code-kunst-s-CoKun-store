<%-- File Location: /views/admin/book/modify.jsp --%>
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">책 수정</h3>
                    </div>
                    <div class="card-body">
                        <form action="${root}admin/book/modify" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="book_id" value="${book.book_id}">
                            <input type="hidden" name="existing_pic" value="${book.book_pic}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="book_category" name="book_category" class="form-control" value="${book.book_category}" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="publisher" name="publisher" class="form-control" value="${book.publisher}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="formattedDate">출판일</label>
                                <%-- <label for="publish_date">출판일</label> --%>
                                <%-- <input type="date" id="publish_date" name="publish_date" class="form-control" value="${fn:substring(book.publish_date, 0, 10)}" readonly> --%>
                            	<input type="text" id="publisher" name="publisher" class="form-control" value="${book.formattedDate}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="book_price">가격</label>
                                <input type="number" id="book_price" name="book_price" class="form-control" value="${book.book_price}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="book_info" name="book_info" class="form-control" rows="3">${book.book_info}</textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="book_pic" name="book_pic" class="form-control" value="${book.book_pic}" required>
                            </div>
