...
<table>
  <tr>
    <td>✔</td>
    <td>현대 사회의 독서량 부족 문제 해결과 지식 함양을 목표로 한다.</td>
  </tr>
  <tr>
    <td>✔</td>
    <td>주 소비층인 20, 30대를 겨냥하여 SNS 기능을 도입함으로써 젊은 사람들의 흥미를 유발하고,<br>자연스럽게 웹사이트 이용을 유도한다.</td>
  </tr>
  <tr>
    <td>✔</td>
    <td>다양한 API를 활용하여 큐레이팅 서비스를 제공함으로 사용자 경험 개선과 안정적인 수익<br>모델을 보장한다.</td>
  </tr>
</table>
<br>   <br>
